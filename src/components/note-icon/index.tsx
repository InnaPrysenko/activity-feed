...
const NoteIcon: React.FC<{
  ...
  return (
    <div
      className={`flex items-center justify-center w-4 h-4 md:w-7 md:h-7 p-0.5 md:p-1.5 aspect-square bg-foreground-500 rounded-full cursor-pointer select-none
